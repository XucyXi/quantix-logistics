        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p style={{ fontSize: "0.85rem", lineHeight: 1.7, marginBottom: "1.25rem" }}>
              Moderni ruokalogistiikka-järjestelmä, joka yhdistää jakelukeskukset, kuljettajat ja kaupat saumattomasti.
            </p>
          ...
          {/* Links */}
          <div>
            <h4 style={{ color: "#ffffff", fontWeight: 600, marginBottom: "1rem", fontSize: "0.9rem" }}>
              Palvelut
            </h4>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {[
                ...
                <div key={text} style={{ display: "flex", alignItems: "flex-start", gap: "0.625rem", fontSize: "0.85rem" }}>
                  <Icon size={15} style={{ color: "#f97316", marginTop: 2, flexShrink: 0 }} />
                  <span>{text}</span>
                </div>
              ))}
            </div>
