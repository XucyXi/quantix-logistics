...
export function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (ok) {
      ...
      setError('Virheelliset tunnukset. Demo: admin@quantix.fi / admin123');
    }
  };
    ...
    >
      ...
      >
        ...
        <div style={{position: 'relative', textAlign: 'center'}}>
          ...
          >
            Ylläpidon hallintapaneeli – ruokalogistiikan komentokeskus.
          </p>
      ...
      >
        <div style={{width: '100%', maxWidth: 420}}>
          ...
          >
            ...
            >
              <strong>Demo:</strong> admin@quantix.fi / admin123
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{marginBottom: '1.25rem'}}>
                ...
                <input
                  ...
                  required
                  placeholder="yllapito@quantix.fi"
                  style={{
                    width: '100%',
                    padding: '0.75rem 1rem',
                    borderRadius: 10,
              ...
              >
                {loading ? 'Kirjaudutaan...' : 'Kirjaudu ylläpitoon'}
              </button>
            </form>
