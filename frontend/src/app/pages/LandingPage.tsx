...
export function LandingPage() {
  return (
    <div style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <div style={{ width: 7, height: 7, borderRadius: "50%", backgroundColor: "#f97316" }} />
              ...
              >
                Quantix Logistics yhdistaa jakelukeskuksen, kuljettajat ja kaupat saumattomaksi
                digitaaliseksi ketjuksi - reaaliaikaisesti, lapinakyvasti ja tehokkaasti.
              </p>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", marginTop: "2.5rem" }}>
                {["HACCP-sertifioitu", "ISO 22000", "GDPR-yhteensopiva"].map((tag) => (
                  <div
                    key={tag}
                    style={{
                      display: "flex",
      ...
      <section style={{ backgroundColor: "#f8fafc", padding: "2rem 1.5rem" }} className="lg:hidden">
      ...
      <section style={{ backgroundColor: "#f8fafc", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
            ...
            <p style={{ color: "#64748b", fontSize: "1rem", maxWidth: 580, margin: "0 auto" }}>
              Quantix yhdistaa kaikki toimitusketjun osat yhteen alykkaaseen jarjestelmaan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((f, i) => (
              ...
              >
                ...
                <h3 style={{ color: "#0f2444", marginBottom: "0.625rem", fontSize: "1rem", fontWeight: 700 }}>
                  {f.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} style={{ textAlign: "center" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.9rem", lineHeight: 1.7 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ backgroundColor: "#f8fafc", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <h2 style={{ color: "#0f2444", fontSize: "clamp(1.75rem, 3vw, 2.5rem)", fontWeight: 800 }}>
              Portaalit jokaiselle roolille
            </h2>
            <p style={{ color: "#64748b", marginTop: "0.75rem" }}>
              Kolme erillista kayttajaroolia, kukin omalla raataloidylla nakymallaan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {roles.map((r) => (
              ...
              >
                ...
                <h3 style={{ fontWeight: 800, fontSize: "1.2rem", marginBottom: "0.75rem" }}>{r.role}</h3>
                <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: 1.65, flex: 1 }}>
                  {r.desc}
                </p>
                <Link
                  to={r.to}
      ...
      <section style={{ backgroundColor: "white", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            <h2 style={{ color: "#0f2444", fontSize: "clamp(1.5rem, 3vw, 2.25rem)", fontWeight: 800 }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {testimonials.map((t) => (
              ...
              >
                ...
                <div>
                  <div style={{ fontWeight: 700, color: "#0f2444", fontSize: "0.9rem" }}>{t.name}</div>
      ...
      >
        <div style={{ maxWidth: 700, margin: "0 auto" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "1.05rem", marginBottom: "2rem" }}>
            Liity satojen kauppojen joukkoon ja koe ero reaaliaikaisessa ruokalogistiikassa.
          </p>
